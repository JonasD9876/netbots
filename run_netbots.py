...
run_python_in_terminal("NetBot-Server", "src/netbots_server.py -p 20000 -stepsec 0.05 -games 3 -stepmax 3000")
run_python_in_terminal("NetBot-Viewer", "src/netbots_viewer.py -p 20001 -sp 20000")
run_python_in_terminal("circler", "robots/circler.py -p 20002 -sp 20000")
...
run_python_in_terminal("hideincorner", "robots/hideincorner.py -p 20005 -sp 20000")
